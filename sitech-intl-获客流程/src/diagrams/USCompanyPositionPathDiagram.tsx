    ...
    >
      ...
      >
        <PositionCard
          ...
          body="美国公司辅佐真正有目标、有野心、有产品潜力的国内团队进入美国市场，国内团队有且仅是产品的唯一主体，基于公司想要把优秀的产品引入到国外市场的战略。美国公司负责本地获客、客户触达、合作机会、市场反馈，也可以用国外视角出辅助国内。但美国公司不替代国内的产品主体，最终的产品规划、结构设计、UI/UX、开发、部署都是国内的职责。"
          keywords={["国外辅助", "国内唯一主体", "美国试探获客"]}
          tone="blue"
        />
        <PositionCard
          index="2"
          title="从公司“简历”和三条获客路径出发，扩大业务与合作交流圈"
          body="美国公司要把国内优秀能力、产品、官网、PPT、Demo 和案例沉淀成对外“简历”，再围绕三条商业路径持续获客、寻找合作、扩大业务机会、建立行业交流圈，并把真实市场信号反哺到国内。"
          keywords={[
            "简历获客",
            "三条路径",
            "合作机会",
      ...
      >
        <StepCard
          step="Step 1"
          tone="legacy"
          title="旧模式：两个主体一起拼凑起功能、设计和开发"
          body="过去，美国公司持续按照国内团队要求，做功能、做设计、和国内主体拼凑出结果。美国公司自身没有完整人力和工程资源，却在产品过程中承担了部分主体职责。导致最后双边去拼凑出产品，产品主体不清晰，决策效率低下，协作不畅。"
          bullets={[
            "拼功能、拼设计、拼开发，产品主体逐渐变成两个",
            "美国公司没有足够产品、设计、工程资源，却长期推动国内主体完成产品",
            "时区、沟通效率、工作权限和信息同步都会放大协作成本",
            "每一步都需要两边反复确认，决策速度变慢",
            "美国公司容易陷入产品细节，而不是更重要的市场获客和客户验证",
          ]}
          conclusion="旧模式的核心问题是：美国公司在没有完整资源的情况下和国内一起拼产品，导致产品所有权和决策主体不清晰。"
        />
        ...
        <StepCard
          ...
          bullets={[
            "美国公司提供：市场调研、竞品分析、客户反馈、使用场景、文字说明、图片说明、和视频说明",
            "国内团队基于这些输入，自主完成产品目标、功能设计、开发决策、产品沉淀和长期迭代的全流程",
            "国内团队不能因为内容和美国有关系，就把主体责任给到美国，要求美国输出比如详细的功能设计，希望美国手把手教国内做成什么产品。这是国内团队的产品主体，国内团队已经有了齐全的海外的文字图片视频信息，应该很清楚自己要做的产品是什么，加上搜索和AI工具的发达，是能够主动完成产品的全流程的。",
            "遇到客户理解、场景判断或海外表达问题时，再和美国公司确认或协助",
          ]}
          conclusion="美国公司把美国市场信息整理清楚，国内团队就可以自主开发和迭代；美国公司协助验证，但不成为第二个产品主体。"
        />
        <FlowArrow color={colors.green} />
        <StepCard
          step="Step 3"
          tone="growth"
          title="业务增长：国内优秀产品形成对应美国支撑团队"
          body="当某个国内优秀产品在美国获得客户、试点、收入和持续业务增长后，它自然需要对应的美国团队支持，这是产品业务增长后的必然结果。"
          bullets={[
            "美国本地团队包含：Sales、Operations、Customer Success、Technical Support、Engineer",
            "美国团队服务这个产品在美国的销售、运营、交付、客户成功和技术支持",
            "产品主体、产品归属权和长期产品沉淀仍然属于国内团队",
            "美国公司负责把客户增长和本地团队组织起来，不抢产品主体",
          ]}
          conclusion="每一个真正做大的产品，最后都会长出对应的美国团队；但这个产品归属仍是国内团队，美国支撑团队是业务增长后的结果。"
        />
        ...
        <StepCard
          ...
          body="当多个国内产品在美国持续获得客户和收入后，会形成多个对应的海外团队；这些团队可能各自服务不同产品，也可能在客户、运营、技术支持和渠道上有交集。"
          bullets={[
            "多个产品带来更多客户、更多合作、更多海外业务机会",
            "多个海外团队可以共享客户资源、渠道关系、运营经验和本地支持能力",
            "美国公司核心人员负责公司发展、战略判断、组织结构、运营优化和资源分配",
            "目标是让美国公司服务更多客户、支持更多海外产品，并形成更强大的美国团队",
            "产品主体",
          ]}
          conclusion="美国公司长期要管理和优化多个海外业务团队，让更多国内优秀产品在美国长出来。"
        />
      </section>
      ...
      >
        ...
        >
          ...
          >
            美国公司的短期重点是提供美国市场输入、获客和客户验证；中期目标是让成功产品长出对应美国团队；长期目标是管理多个海外业务团队，扩大客户、合作、自有海外产品和美国团队能力。
          </div>
        </div>
      </section>
