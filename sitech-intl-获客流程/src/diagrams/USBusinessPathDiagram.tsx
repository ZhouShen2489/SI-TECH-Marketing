    ...
    >
      ...
      >
        <SectionTitle
          ...
          title="展示面为什么重要"
          description="这不是路径一或路径二的附属内容，而是三条路径共同依赖的第一层信任。客户愿不愿意继续聊，往往先取决于呈现。"
        />
        <div
          style={{
            display: "grid",
  ...
  return (
    ...
    >
      <div>
        ...
        <div style={{ fontSize: 14, color: "#5F728F", lineHeight: 1.58 }}>
          国内团队先发生认知改变，形成海外市场心态和决心，并对产品负责；美国侧从早期场景和
          Demo
          阶段就开始找合作伙伴和客户反馈，双方通过反馈循环逐步走向产品化运营。
        </div>
      </div>
      ...
      >
        ...
        <SideStepList
          ...
          items={[
            "认知改变，理解海外市场的巨大机会",
            "形成做海外产品的心态、野心和决心，对产品负责",
            "按优势产品 / 现有产品 / 获客潜力 / 赚钱潜力等维度选择场景",
            "完成海外场景的 PPT / MVP Demo 作为展示面",
            "根据美国客户反馈，调整资源投入",
            "让产品逐步走向产品化运营，持续迭代升级",
          ]}
        />
  ...
  return (
    ...
    >
      <div style={{ marginBottom: 24 }}>
        ...
        >
          通过可靠可信任的展示面扩大本地接触面，在三条路径中寻找合作机会，并逐步形成可持续收入。
        </div>
      </div>
      ...
      >
        ...
        >
          <SectionTitle
            ...
            title="共同基础：可信展示面与获客动作"
            description="三条路径共同依赖这层基础。没有展示面，客户很难建立信任；没有获客动作，就没有反馈和合作关系。"
          />
          <TagRow
            items={[
              "Sitech Intl 新官网",
              "Sitech Intl LinkedIn",
              "某优势产品/解决方案的一页纸材料",
              "案例 / 解决方案故事",
              "某产品的Demo / 视频 / 业务PPT",
              "接触客户模版材料",
      ...
      >
        <PathCard
          ...
          canDoItems={["做美国侧展示面", "找全球客户交流", "形成合作合同"]}
        />
